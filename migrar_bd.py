"""
Script de migración para actualizar la base de datos al nuevo sistema de roles dinámicos.
Ejecuta este script para limpiar la BD antigua y crear la nueva con el super admin.
"""
