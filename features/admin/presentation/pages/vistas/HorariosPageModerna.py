...
class HorariosPageModerna(LayoutBase):
    ...
    def __init__(self, pagina: ft.Page, usuario):
        ...
        # Tabla de horarios (referencia para actualizar)
        self._tabla_horarios = None
    ...
    def _cargar_datos(self):
        ...
        if self._tabla_horarios:
            self._actualizar_tabla_horarios()

    def _actualizar_tabla_horarios(self):
        """Actualiza la tabla de horarios con los datos cargados"""
        if self._tabla_horarios:
            self._tabla_horarios.rows = self._generar_filas_horarios()
            self._pagina.update()
