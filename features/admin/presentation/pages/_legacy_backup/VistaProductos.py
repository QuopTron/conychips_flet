...
class VistaProductos(VistaBase):
    ...
    def _abrir_popup_crear(self, e):
        campo_nombre = ft.TextField(label="Nombre", prefix_icon=ft.icons.Icons.Icons.FASTFOOD)
        campo_descripcion = ft.TextField(label="Descripción", multiline=True, min_lines=2, max_lines=4)
        campo_precio = ft.TextField(label="Precio (en centavos)", prefix_icon=ft.icons.Icons.Icons.ATTACH_MONEY, keyboard_type=ft.KeyboardType.NUMBER)
        campo_stock = ft.TextField(label="Stock inicial", prefix_icon=ft.icons.Icons.Icons.INVENTORY, keyboard_type=ft.KeyboardType.NUMBER, value="0")
        campo_imagen = ft.TextField(label="URL Imagen", prefix_icon=ft.icons.Icons.Icons.IMAGE, hint_text="assets/productos/imagen.jpg")
    ...
    def _abrir_popup_editar(self, producto):
        campo_nombre = ft.TextField(label="Nombre", value=producto.NOMBRE, prefix_icon=ft.icons.Icons.Icons.FASTFOOD)
        campo_descripcion = ft.TextField(label="Descripción", value=producto.DESCRIPCION or "", multiline=True, min_lines=2, max_lines=4)
        campo_precio = ft.TextField(label="Precio (en centavos)", value=str(producto.PRECIO), prefix_icon=ft.icons.Icons.Icons.ATTACH_MONEY, keyboard_type=ft.KeyboardType.NUMBER)
        campo_stock = ft.TextField(label="Stock", value=str(producto.STOCK or 0), prefix_icon=ft.icons.Icons.Icons.INVENTORY, keyboard_type=ft.KeyboardType.NUMBER)
        campo_imagen = ft.TextField(label="URL Imagen", value=producto.IMAGEN or "", prefix_icon=ft.icons.Icons.Icons.IMAGE)
