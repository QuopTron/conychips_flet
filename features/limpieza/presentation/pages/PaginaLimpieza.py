...
class PaginaLimpieza(ft.Column):
    ...
    def _CONSTRUIR(self):
        ...
        self._BOTON_SUBIR_FOTO = ft.Button(
            "Subir Foto del Local", on_click=self._SUBIR_FOTO
        )
            ...
            ft.Container(
                content=ft.Column(
                    [
                        HEADER,
                        ft.Text(
                            "Asistencia del mes", size=18, weight=ft.FontWeight.BOLD
                        ),
    ...
    def _CARGAR_REPORTES(self):
        ...
        reportes = (
            ...
            .filter_by(USUARIO_ID=self._USUARIO_ID)
            ...
            fila = ft.Row(
                [
                    ft.Column(
                        [
                            ft.Text(
                                f"Reporte {r.FECHA.strftime('%Y-%m-%d')}",
