import flet as ft
from core.base_datos.ConfiguracionBD import OBTENER_SESION, MODELO_PEDIDO, MODELO_SUCURSAL
...
class PaginaCocina(ft.Column):
    ...
    def _CONSTRUIR(self):
        ...
        self.controls = [
            ft.Container(content=ft.Column([
                ...
                ft.Text("Pedidos para preparar", size=18, weight=ft.FontWeight.BOLD),
    ...
    async def _CARGAR_PEDIDOS(self):
        ...
        ).order_by(MODELO_PEDIDO.FECHA_CREACION.asc()).all()
        ...
        for p in pedidos:
            ...
            estado_color = ft.Colors.ORANGE_400 if p.ESTADO == 'confirmado' else ft.Colors.BLUE_600
            fila = ft.Row([
                ft.Column([
                ...
                ft.Column([
                    ft.Button("Marcar Listo", on_click=lambda e, ped=p: asyncio.create_task(self._MARCAR_LISTO(ped))),
                    ft.Button("Prioridad Alta", on_click=lambda e, ped=p: asyncio.create_task(self._NOTIFICAR_ATENCION(ped, True)))
                ])
